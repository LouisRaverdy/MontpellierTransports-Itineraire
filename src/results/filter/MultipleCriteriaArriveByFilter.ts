 ...
 */
export class MultipleCriteriaArriveByFilter implements JourneyFilter {
  ...
  private sort(a: Journey, b: Journey): number {
    return a.arrivalTime !== b.arrivalTime ? a.arrivalTime - b.arrivalTime : b.departureTime - a.departureTime ;
  }
